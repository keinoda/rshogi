...
1536x16x32 / 1536x32x32 / 768x16x32 / 768x8x32 / 512x16x32 / 1024x16x32 / 2048x16x64 / 3072x16x64 などの dim、PSQT / Threat 等の拡張、を
...
| `edition-layerstacks-halfka_hm_merged-2048x16x64-none` | 拡大 L0=2048 / L3=64 (tatara `--ft-out 2048 --l1 16 --l2 64`) |
| `edition-layerstacks-halfka_hm_merged-2048x16x64-psqt` | 同上 + PSQT |
| `edition-layerstacks-halfka_hm_merged-3072x16x64-none` | 拡大 L0=3072 / L3=64 |
| `edition-layerstacks-halfka_hm_merged-3072x16x64-psqt` | 同上 + PSQT |
...
3. **L1×L2 dim** (どれか 1 つ): `layerstacks-1536x16x32` (default) / `layerstacks-1536x32x32`
   ...
   / `layerstacks-1024x16x32` / `layerstacks-2048x16x64` / `layerstacks-3072x16x64`
   (末尾 2 つは L2 出力 = 64、tatara `--l2 64` net 用)。複数同時指定は cycles +5.5% 退行
...
| LayerStack 2048x16x64 | `layerstacks-halfka_hm_merged-2048x16x64-none` | `--no-default-features --features search-no-pass-rules,layerstack-arch,ft-halfka_hm_merged,layerstacks-2048x16x64` |
| LayerStack 3072x16x64 | `layerstacks-halfka_hm_merged-3072x16x64-none` | `--no-default-features --features search-no-pass-rules,layerstack-arch,ft-halfka_hm_merged,layerstacks-3072x16x64` |
