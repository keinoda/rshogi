...
```bash
cd /home/sh11235/development/rshogi
...
```bash
python3 /mnt/nvme1/development/rshogi-nnue/checkpoints/inspect_ft.py <ckpt.bin> | head -3
...
```bash
grep -E '^[a-z][a-z0-9-]+ =' /home/sh11235/development/rshogi/crates/rshogi-core/Cargo.toml
```
